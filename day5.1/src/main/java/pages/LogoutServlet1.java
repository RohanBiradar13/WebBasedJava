...
public class LogoutServlet1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter pw = response.getWriter()) {
            ...
            if (userDetails != null) {
                pw.println("<div class='title'>Logout</div>");
                pw.println("<h5>Hello, " + userDetails.getFirstName() + "</h5>");
            }

            session.invalidate();
            pw.println("<h5>You have logged out.</h5>");
            pw.println("<h5><a href='login.html'>Visit Again</a></h5>");
            pw.println("</div>");
            pw.println("</body>");
            pw.println("</html>");
        }
