	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter pw = response.getWriter()) {
			...
			if (user == null) {
				...
				//add topic dao instance under the session scope so that other sevlets can share the same
				session.setAttribute("topic_dao", topicDao );
				//add tutorial dao instance under the session scope so that other servlets can share the same
